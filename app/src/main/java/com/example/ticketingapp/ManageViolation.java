...
public class ManageViolation extends AppCompatActivity {
    ...
    private static String urlHostFN = "http://192.168.1.6/TicketingSystem/selectViolationFN.php";
    private static String urlHostDOB = "http://192.168.1.6/TicketingSystem/selectViolationDOB.php";
    private static String urlHostLN = "http://192.168.1.6/TicketingSystem/selectViolationLicense.php";
    private static String urlHostTOV = "http://192.168.1.6/TicketingSystem/selectViolationTOV.php";
    private static String urlHostDelete = "http://192.168.1.6/TicketingSystem/delete.php";
